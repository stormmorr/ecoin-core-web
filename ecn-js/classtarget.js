...
{	
	...
	this.m_idx_vec_Color = 8;
	
	for(var f_CountVertex = 0; f_CountVertex < this.m_idx_vec_Vertex; f_CountVertex++)
		{
...
classTarget.prototype.acFrom_Humanoid = function()
{
	this.m_Mark = 0.0;
	
	var f_Head = new classElement();
	var f_Torso = new classElement();
	var f_Pelvis = new classElement();
	var f_RightArm = new classElement();
	var f_LeftArm = new classElement();
	var f_RightLeg = new classElement();
	var f_LeftLeg = new classElement();
	
	f_Head.acFromVolume(0.35);
	f_Torso.acFromVolume(1.0);
	f_Pelvis.acFromVolume(0.45);
	f_RightArm.acFromVolume(0.35);
	f_LeftArm.acFromVolume(0.35);
	f_RightLeg.acFromVolume(0.55);
	f_LeftLeg.acFromVolume(0.55);

	f_Head.m_vec_Element[f_Head.m_idx_vec_Element] = f_Head;
	f_Head.m_idx_vec_Element++;
	f_Torso.m_vec_Element[f_Torso.m_idx_vec_Element] = f_Head;
	f_Torso.m_idx_vec_Element++;
	f_Pelvis.m_vec_Element[f_Pelvis.m_idx_vec_Element] = f_Head;
	f_Pelvis.m_idx_vec_Element++;
	f_RightArm.m_vec_Element[f_RightArm.m_idx_vec_Element] = f_Head;
	f_RightArm.m_idx_vec_Element++;
	f_LeftArm.m_vec_Element[f_LeftArm.m_idx_vec_Element] = f_Head;
	f_LeftArm.m_idx_vec_Element++;
	f_RightLeg.m_vec_Element[f_RightLeg.m_idx_vec_Element] = f_Head;
	f_RightLeg.m_idx_vec_Element++;
	f_LeftLeg.m_vec_Element[f_LeftLeg.m_idx_vec_Element] = f_Head;
	f_LeftLeg.m_idx_vec_Element++;

	var f_Leg1 = new classLeg();
	var f_Leg2 = new classLeg();
	var f_Leg3 = new classLeg();
	var f_Leg4 = new classLeg();
	var f_Leg5 = new classLeg();
	var f_Leg6 = new classLeg();
	var f_Leg7 = new classLeg();

	f_Leg1.acSetPos(f_Head.m_Center);
	f_Leg2.acSetPos(f_Torso.m_Center);
	f_Leg3.acSetPos(f_Pelvis.m_Center);
	f_Leg4.acSetPos(f_RightArm.m_Center);
	f_Leg5.acSetPos(f_LeftArm.m_Center);
	f_Leg6.acSetPos(f_RightLeg.m_Center);
	f_Leg7.acSetPos(f_LeftLeg.m_Center);

	f_Head.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg1;
	f_Head.m_idx_vec_Leg++;
	f_Torso.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg2;
	f_Torso.m_idx_vec_Leg++;
	f_Pelvis.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg3;
	f_Pelvis.m_idx_vec_Leg++;
	f_RightArm.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg4;
	f_RightArm.m_idx_vec_Leg++;
	f_LeftArm.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg5;
	f_LeftArm.m_idx_vec_Leg++;
	f_RightLeg.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg6;
	f_RightLeg.m_idx_vec_Leg++;
	f_LeftLeg.m_vec_Leg[f_Head.m_idx_vec_Leg] = f_Leg7;
	f_LeftLeg.m_idx_vec_Leg++;
	
	f_Head.m_Index = 0;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_Head;
	this.m_Collection.m_idx_vec_Element++;
	f_Torso.m_Index = 1;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_Torso;
	this.m_Collection.m_idx_vec_Element++;
	f_Pelvis.m_Index = 2;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_Pelvis;
	this.m_Collection.m_idx_vec_Element++;
	f_RightArm.m_Index = 3;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_RightArm;
	this.m_Collection.m_idx_vec_Element++;
	f_LeftArm.m_Index = 4;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_LeftArm;
	this.m_Collection.m_idx_vec_Element++;
	f_RightLeg.m_Index = 5;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_RightLeg;
	this.m_Collection.m_idx_vec_Element++;
	f_LeftLeg.m_Index = 6;
	this.m_Collection.m_vec_Element[this.m_Collection.m_idx_vec_Element] = f_LeftLeg;
	this.m_Collection.m_idx_vec_Element++;

	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_Head.m_vec_Leg[0];
	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_Torso.m_vec_Leg[0];
	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_Pelvis.m_vec_Leg[0];
	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_RightArm.m_vec_Leg[0];
	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_LeftArm.m_vec_Leg[0];
	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_RightLeg.m_vec_Leg[0];
	this.m_Collection.m_vec_Leg[this.m_Collection.m_idx_vec_Leg] = f_LeftLeg.m_vec_Leg[0];
	
	f_Torso.m_vec_Element[f_Torso.m_idx_vec_Element] = f_Head;
	f_Torso.m_vec_Leg[f_Torso.m_idx_vec_Leg] = f_Head.m_vec_Leg[0];

	f_Torso.m_vec_Element[f_Torso.m_idx_vec_Element] = f_Pelvis;
	f_Torso.m_vec_Leg[f_Torso.m_idx_vec_Leg] = f_Pelvis.m_vec_Leg[0];

	f_Pelvis.m_vec_Element[f_Pelvis.m_idx_vec_Element] = f_LeftLeg;
	f_Pelvis.m_vec_Leg[f_Pelvis.m_idx_vec_Leg] = f_LeftLeg.m_vec_Leg[0];

	f_Pelvis.m_vec_Element[f_Pelvis.m_idx_vec_Element] = f_RightLeg;
	f_Pelvis.m_vec_Leg[f_Pelvis.m_idx_vec_Leg] = f_RightLeg.m_vec_Leg[0];

	f_Torso.m_vec_Element[f_Torso.m_idx_vec_Element] = f_LeftArm;
	f_Torso.m_vec_Leg[f_Torso.m_idx_vec_Leg] = f_LeftArm.m_vec_Leg[0];

	f_Torso.m_vec_Element[f_Torso.m_idx_vec_Element] = f_RightArm;
	f_Torso.m_vec_Leg[f_Torso.m_idx_vec_Leg] = f_RightArm.m_vec_Leg[0];
	
	for(var f_ElementID2 = 0; f_ElementID2 < this.m_Collection.m_idx_vec_Element; f_ElementID2++)
		{
		for(var f_ElementID3 = 0; f_ElementID3 < this.m_Collection.m_vec_Element[f_ElementID2].m_idx_vec_Element; f_ElementID3++)
			{
			console.log(this.m_Collection.m_vec_Element[f_ElementID2].m_Index);
			console.log(this.m_Collection.m_vec_Element[f_ElementID2].m_vec_Element[f_ElementID3].m_Index);
			}
		}
}
...
classTarget.prototype.acFromHesh = function(f_Hesh)
{
	...
	/*for(int f_Count = 0; f_Count < f_Hesh->m_adIndex.size(); f_Count++)
		{
		classElement* f_Element = this.m_Collection.m_vec_Element[f_Count];

		if(f_Element->m_vec_Collission.size() == 1)
			{
			classElement* f_FriendlyElement = this.m_Collection.m_vec_Element[f_Element->m_vec_Collission[0]];
			...
			for(int f_CountElement = 0; f_CountElement < f_Element->m_vec_Collission.size(); f_CountElement++)
				...
				if(f_Count != f_CountElement)
					{
					classElement* f_FriendlyElement = this.m_Collection.m_vec_Element[f_Element->m_vec_Collission[f_CountElement]];
...
classTarget.prototype.acSaveCloud = function(f_Name, f_Index)
{
	  ////////////////
	 // targets
	//
	var g_syncfield = [];
	g_syncfield[0] = "name";
	g_syncfield[1] = "difficulty";
	g_syncfield[2] = "bckred";
	g_syncfield[3] = "bckgreen";
	g_syncfield[4] = "bckblue";

	var g_syncvalue = [];
	g_syncvalue[0] = f_Name;
	g_syncvalue[1] = 89.75;
	g_syncvalue[2] = Math.random();
	g_syncvalue[3] = Math.random();
	g_syncvalue[4] = Math.random();
	...
	for(var f_ElementID = 0; f_ElementID < this.m_Collection.m_idx_vec_Element; f_ElementID++)
		{
		  ////////////////
		 // element
		//
		var g_syncfield = [];
		g_syncfield[0] = "description";
		g_syncfield[1] = "targetid";
		g_syncfield[2] = "vert1x";
		g_syncfield[3] = "vert1y";
		g_syncfield[4] = "vert1z";
		g_syncfield[5] = "volume";

		var g_syncvalue = [];
		g_syncvalue[0] = "Body Part";
		g_syncvalue[1] = f_Index;
		g_syncvalue[2] = 0.0;
		g_syncvalue[3] = 0.0;
		g_syncvalue[4] = 0.0;
		g_syncvalue[5] = this.m_Collection.m_vec_Element[f_ElementID].m_Volume;
		var f_Volume = this.m_Collection.m_vec_Element[f_ElementID].m_Volume;
	...
	for(var f_ElementID2 = 0; f_ElementID2 < this.m_Collection.m_idx_vec_Element; f_ElementID2++)
		...
		for(var f_ElementID3 = 0; f_ElementID3 < this.m_Collection.m_vec_Element[f_ElementID2].m_idx_vec_Element; f_ElementID3++)
			...
			//
			var g_syncfield = [];
			g_syncfield[0] = "targetid";
			g_syncfield[1] = "elementid";
			g_syncfield[2] = "resultid";

			var g_syncvalue = [];
			g_syncvalue[0] = f_Index;
			g_syncvalue[1] = this.m_Collection.m_vec_Element[f_ElementID2].m_Index;
			g_syncvalue[2] = this.m_Collection.m_vec_Element[f_ElementID2].m_vec_Element[f_ElementID3].m_Index;
						
			var f_Resulttxsync = "";
			for(var f_i = 0; f_i < 3; f_i++)
				{
				f_Resulttxsync += g_syncfield[f_i] + "::::";
				f_Resulttxsync += g_syncvalue[f_i] + "::::";
				}
