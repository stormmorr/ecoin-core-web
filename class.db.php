...
class DBM
{
    ...
    public function log_db_errors( $error, $query )
    {
        ...
        $headers .= 'To: Admin <'.SEND_ERRORS_TO_M.'>' . "\r\n";
        ...
        mail( SEND_ERRORS_TO_M, 'Database Error', $message, $headers);
	...
	public function __construct()
	{
		...
		$this->link = new mysqli( DB_HOST_M, DB_USER_M, DB_PASS_M, DB_NAME_M );
    ...
    public function filter( $data )
    {
        ...
        else
        {
            ...
            $data = array_map( array( 'DBM', 'filter' ), $data );
        }
    	return $data;
    }
