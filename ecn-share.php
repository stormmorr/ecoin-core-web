		...
		<table>
			<tbody>
				<?php
					if($owner == "")
						{
						if(isset($_COOKIE["ecn_walletadr_address1"]))
							{
							$owner = $_COOKIE["ecn_walletadr_address1"];
							}
						}
						
					if($owner != "")
						{
						$f_jobquery = "SELECT id FROM block";
				
						$f_JobID = $database->num_rows($f_jobquery);
						...
						echo "<tr style=\"background-color:#450000;\">";
						echo "<th>";
						echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"ecn-share.php?iddesc=0\">(ID) By Mark</a>";
						echo "</th>";
						echo "<th>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\">Mark</h2>";
						echo "</th>";
						echo "<th>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\">Share Leaderboard</h2>";
						echo "</th>";
						echo "<th>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\">TargetID</h2>";
						echo "</th>";
						echo "<th>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\">Score</h2>";
						echo "</th>";
						echo "<th>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\">Difficulty</h2>";
						echo "</th>";
						echo "<th>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\">Pledge</h2>";
						echo "</th>";
						echo "<th>";
						...
						if($tx_num_row >= 1)
							...
							if($tx_num_row == 1)
								{
								$tx_row = $database->get_row($f_txqueryo1);
								
								echo "<tr style=\"background-color:#450000;\">";
								echo "<td>";
								echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"eglx.php?share=" . $tx_row[1] . "\">" . $tx_row[1] . "</a>";
								echo "</td>";
								echo "<td>";
								...
								echo "</td>";
								echo "<td>";
								echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_row[4] . "</h2>";
								echo "</td>";
								echo "<td>";
								echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_row[5] . "</h2>";
								echo "</td>";
								echo "<td>";
								...
								foreach($tx_results as $tx_result)
									...
									echo "<tr style=\"background-color:#450000;\">";
									echo "<td>";
									echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"eglx.php?share=" . $tx_result["shareid"] . "\">" . $tx_result["shareid"] . "</a>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["mark"] . "</h2>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["blockledger"] . "</h2>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["targetid"] . "</h2>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["score"] . "</h2>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["difficulty"] . "</h2>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["pledge"] . "</h2>";
									echo "</td>";
									echo "<td>";
						...
						echo "</td>";
						echo "<td>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\"><a href=\"ecn-stat.php\">CLOSE BLOCK WINDOW RESULTS</a></h2>";
						echo "</td>";
						echo "</tr>";
						...
						echo "<tr style=\"background-color:#15b1ff;\">";
						echo "<th>";
						echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"ecn-share.php?iddesc=0\">(ID) By Mark</a>";
						echo "</th>";
						echo "<th>";
						...
						if($tx_num_row >= 1)
							...
							if($tx_num_row == 1)
								{
								$tx_row = $database->get_row($f_txqueryo2);
								
								echo "<tr style=\"background-color:#15b1ff;\">";
								echo "<td>";
								echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"eglx.php?share=" . $tx_row[0] . "\">" . $tx_row[0] . "</a>";
								echo "</td>";
								echo "<td>";
								...
								{
								$tx_results = $database->get_results($f_txqueryo2);
								...
								foreach($tx_results as $tx_result)
									...
									echo "<tr style=\"background-color:#15b1ff;\">";
									echo "<td>";
									echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"eglx.php?share=" . $tx_result["id"] . "\">" . $tx_result["id"] . "</a>";
									echo "</td>";
									echo "<td>";
									echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["mark"] . "</h2>";
									echo "</td>";
						...
						echo "</td>";
						echo "<td>";
						echo "<h2 style=\"font-family: Abel;\" class=\"font\"><a href=\"ecn-stat.php\">CLOSE VOTE-LEADERS WINDOW RESULTS</a></h2>";
						echo "</td>";
						echo "</tr>";
						...
						if($iddesc == 0)
							...
							echo "<th>";
							echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"ecn-share.php?iddesc=1\">By ID</a>";
							echo "</th>";
							echo "<th>";
							echo "<h2 style=\"font-family: Abel;\" class=\"font\">Mark</h2>";
							echo "</th>";
							echo "<th>";
							echo "<h2 style=\"font-family: Abel;\" class=\"font\">JobID</h2>";
							echo "</th>";
							echo "<th>";
							echo "<h2 style=\"font-family: Abel;\" class=\"font\">TargetID</h2>";
							echo "</th>";
							...
							if($tx_num_row >= 1)
								...
								if($tx_num_row == 1)
									{
									$tx_row = $database->get_row($f_txqueryo3);
									...
									{
									$tx_results = $database->get_results($f_txqueryo3);
									...
									foreach($tx_results as $tx_result)
										...
										echo "</td>";
										echo "<td>";
										echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["jobid"] . "</h2>";
										echo "</td>";
										echo "<td>";
										echo "<h2 style=\"font-family: Abel;\" class=\"font\">" . $tx_result["targetid"] . "</h2>";
										echo "</td>";
							...
							echo "</td>";
							echo "<td>";
							echo "<h2 style=\"font-family: Abel;background-color:orange;\" class=\"font\"><a href=\"ecn-stat.php\">CLOSE SHARE WINDOW RESULTS</a></h2>";
							echo "</td>";
							echo "</tr>";
							}
						else if($iddesc == 1)
							...
							echo "<tr style=\"background-color:orange;\">";
							echo "<th>";
							echo "<a style=\"font-family: Abel;\" class=\"font\" href=\"ecn-share.php?iddesc=0&owner=" . $owner . "\">(ID) By Mark</a>";
							echo "</th>";
							echo "<th>";
							echo "<h2 style=\"font-family: Abel;\" class=\"font\">Mark</h2>";
							echo "</th>";
							...
							if($tx_num_row >= 1)
								...
								if($tx_num_row == 1)
									{
									$tx_row = $database->get_row($f_txqueryo4);
									...
									{
									$tx_results = $database->get_results($f_txqueryo4);
		...
		<script>
			/*window.addEventListener('load', 
				function()
					...
					document.getElementById("ecnshareauth").innerHTML = "<a href='http://www.bitcoin-office.com/ecn-share.php?owner=" + g_Wallet.GetAdr() + "' style=\"font-family: Abel;\" onmouseover=\"clicksound.playclip()\" class=\"font\">share.ECN.world</a>";
					},
				false);*/
		</script>
	</body>
